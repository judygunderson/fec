<?php
$configuration = $db->Execute("SELECT configuration_group_id FROM " . TABLE_CONFIGURATION_GROUP . " WHERE configuration_group_title = 'Fast and Easy Checkout Configuration' ORDER BY configuration_group_id ASC;");
...
$db->Execute("INSERT INTO " . TABLE_CONFIGURATION_GROUP . " (configuration_group_title, configuration_group_description, sort_order, visible) VALUES ('Fast and Easy Checkout Configuration', 'Set Fast and Easy Checkout Configuration Options', '1', '1');");
...
('Version', 'FAST_AND_EASY_CHECKOUT_VERSION', '1.12.0', 'Version Installed:', " . $configuration_group_id . ", 0, NOW(), NOW(), NULL, NULL),
...
$messageStack->add('Installed Fast and Easy Checkout v1.12.0', 'success');
